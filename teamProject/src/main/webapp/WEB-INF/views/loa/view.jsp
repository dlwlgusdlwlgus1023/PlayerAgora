...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/loa/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/loa/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/loa/update.do";
		...
		<div id="headbtn">
			<table>
				<tr>
					...
					<td><a href="${path}/loa/list3.do">공략/팁</a></td>
					<td><a href="${path}/loa/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listLoa.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
				...
				<div id="writecont">
					...
					<table>
						...
						<tr>
							...
							<td colspan="3">
								<div>
				<div><a href="https://playoverwatch.com/ko-kr/" target="_blank" id="main-banner"><img src="../images/loa_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/loa/delete.do";
												document.form1.submit();
											}
										});
					</script>
