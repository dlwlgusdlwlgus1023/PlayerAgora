...
<%@ page import="com.example.teamProject.model.dot.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="http://kr.dota2.com/" target="_blank" id="main-banner"><img src="../images/dot_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
