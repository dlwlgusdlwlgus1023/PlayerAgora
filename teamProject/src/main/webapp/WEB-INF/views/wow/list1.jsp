...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/wow/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/wow/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/wow/list1.do">WOW</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/wow/list1.do">
