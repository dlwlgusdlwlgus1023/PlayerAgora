...
<%@ page import="com.example.teamProject.model.mps.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://maplestory.nexon.com/Home/Main" target="_blank" id="main-banner"><img src="../images/mps_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
