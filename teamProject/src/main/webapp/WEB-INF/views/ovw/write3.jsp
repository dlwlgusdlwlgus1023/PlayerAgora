...
<%@ page import="com.example.teamProject.model.ovw.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://playoverwatch.com/ko-kr/" target="_blank" id="main-banner"><img src="../images/ovw_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
