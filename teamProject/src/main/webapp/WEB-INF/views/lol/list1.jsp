...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/lol/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/lol/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/lol/list1.do">리그오브레전드</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/lol/list1.do">
