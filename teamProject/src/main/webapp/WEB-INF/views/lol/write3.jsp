...
<%@ page import="com.example.teamProject.model.lol.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://kr.leagueoflegends.com/ko-kr/" target="_blank" id="main-banner"><img src="../images/lol_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
