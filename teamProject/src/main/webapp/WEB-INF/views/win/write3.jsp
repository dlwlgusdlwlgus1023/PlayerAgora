...
<%@ page import="com.example.teamProject.model.win.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://www.konami.com/wepes/2020/as/ko/ps4/" target="_blank" id="main-banner"><img src="../images/win_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
