...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/win/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/win/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/win/update.do";
		...
		<div id="headbtn">
			<table>
				<tr>
					...
					<td><a href="${path}/win/list3.do">공략/팁</a></td>
					<td><a href="${path}/win/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listWin.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/win/delete.do";
												document.form1.submit();
											}
										});
					</script>
