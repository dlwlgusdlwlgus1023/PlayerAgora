				...
				function() {
					...
					$(".uploadedList .file").each(
							function(i) {
								...
								str += "<input type='hidden' id='game' name='game'	value='니드 포 스피드'>";
								str += "<input type='hidden' id='abb' name='abb'	value='Nfs'>";
					//폼에 hidden 태그들을 붙임
					$("#form1").append(str);
			...
			<table id="Notice" style="width: 100%; max-width: 880px;">
				...
				<tr>
					<td>게시판에 링크하고 싶은 이미지가 많은데 한 게시물에 업로드 가능한 개수를 초과할 경우,
						...
						<label>▶ 니드 포 스피드 스크린샷 게시판 이용안내</label><br> <br> -
			...
			<div>
				...
				<div class="fileDrop" style="overflow:auto;">
					...
					<div class="fileDrop-desc">
						...
						<div style="margin: 10px;">
						<div class="col three" style="width: 100%;">
						<a onclick="location.href='listNfs.do'" class="btn btn-dark" >목록으로</a>		
						</div>
						</div>	
						<br><br>
