...
$(function(){
	$("#btnWrite").click(function(){
		...
		location.href="${path}/teamProject/screenshot/writeSta.do";
		} else {
...
function list(page){
	location.href="${path}/teamProject/screenshot/listSta.do?curPage="+page;
	...
	<%@ include file="../include/headerBody.jsp" %>
		<div class="container-fluid text-center">
			...
			<div id="headbtn">
				<table>
					<tr>
						<td><a href="${path}/sta/list1.do">스타크래프트</a></td>
						<td><a href="${path}/sta/list2.do">패치노트</a></td>
						<td><a
							href="${path}/sta/list3.do">공략/팁</a></td>
						<td><a href="${path}/sta/list4.do">파티모집</a></td>
						<td style="background-color: gray;"><a
							href="${path}/screenshot/listSta.do">스크린샷</a></td>
					</tr>
				</table>
			</div>
				<br> <br> <br> <br> <br>
				<div class="col-md-9 text-left" id="screen">
						<form name="form1" method="post" action="${path}/screenshot/listSta.do">
...
<th style="text-align: left;  ">
	...
	<c:forEach var="row" items="${map.list}" >
		...
		margin: 25px; ">
		<div style="position : relative; vertical-align : middle; line-height : 200px;" onclick="location.href='${path}/screenshot/viewSta.do?bno=${row.bno}';">
		...
		border: 1px solid gray; overflow: hidden;" onclick="location.href='${path}/screenshot/viewSta.do?bno=${row.bno}';">
