				...
				function() {
					...
					$(".uploadedList .file").each(
							function(i) {
								...
								str += "<input type='hidden' id='game' name='game'	value='문명'>";
								str += "<input type='hidden' id='abb' name='abb'	value='Civ'>";
					//폼에 hidden 태그들을 붙임
					$("#form1").append(str);
...
<div style="height: 100%; width: 100%">
	...
	<div class="container-fluid text-center">
			...
			<%@ include file="../include/left_menu.jsp" %>
				...
				<form id="form1" name="form1" method="post" action="${path}/screenshot/insertCiv.do">
			<div id="writecont">
			...
			<table id="Notice" style="width: 100%; max-width: 880px;">
				...
				<tr>
					<td>게시판에 링크하고 싶은 이미지가 많은데 한 게시물에 업로드 가능한 개수를 초과할 경우,
						...
						<label>▶ 문명 스크린샷 게시판 이용안내</label><br> <br> -
			...
			<div>
				...
				<div class="fileDrop" style="overflow:auto;">
					...
					<div class="fileDrop-desc">
						...
						<div style="margin: 10px;">
						<div class="col three" style="width: 100%;">
						<a onclick="location.href='listCiv.do'" class="btn btn-dark" >목록으로</a>		
						</div>
						</div>	
						<br><br>
