...
body{
	background-image: url("../images/loa2.jpg");
	width: 100%;
	height: 100%;
...
$(function(){
	$("#btnWrite").click(function(){
		...
		location.href="${path}/teamProject/screenshot/writeLoa.do";
		} else {
...
function list(page){
	location.href="${path}/teamProject/screenshot/listLoa.do?curPage="+page;
	...
	<%@ include file="../include/headerBody.jsp" %>
		<div class="container-fluid text-center">
			...
			<div id="headbtn">
				<table>
					<tr>
						<td><a href="${path}/loa/list1.do">로스트아크</a></td>
						<td><a href="${path}/loa/list2.do">패치노트</a></td>
						<td><a
							href="${path}/loa/list3.do">공략/팁</a></td>
						<td><a href="${path}/loa/list4.do">파티모집</a></td>
						<td style="background-color: gray;"><a
							href="${path}/screenshot/listLoa.do">스크린샷</a></td>
					</tr>
				</table>
			</div>
				<br> <br> <br> <br> <br>
				<div class="col-md-9 text-left" id="screen">
						<form name="form1" method="post" action="${path}/screenshot/listLoa.do">
...
<th style="text-align: left;  ">
	...
	<c:forEach var="row" items="${map.list}" >
		...
		margin: 25px; ">
		<div style="position : relative; vertical-align : middle; line-height : 200px;" onclick="location.href='${path}/screenshot/viewLoa.do?bno=${row.bno}';">
		...
		border: 1px solid gray; overflow: hidden;" onclick="location.href='${path}/screenshot/viewLoa.do?bno=${row.bno}';">
