...
$(function(){
	$("#btnWrite").click(function(){
		...
		location.href="${path}/teamProject/screenshot/writeBtg.do";
		} else {
...
function list(page){
	location.href="${path}/teamProject/screenshot/listBtg.do?curPage="+page;
			...
			<div id="headbtn">
				<table>
					<tr>
						...
						<td><a
							href="${path}/btg/list3.do">공략/팁</a></td>
						<td><a href="${path}/btg/list4.do">파티모집</a></td>
						<td style="background-color: gray;"><a
							href="${path}/screenshot/listBtg.do">스크린샷</a></td>
					</tr>
				</table>
			</div>
				...
				<div class="col-md-9 text-left" id="screen">
						<form name="form1" method="post" action="${path}/screenshot/listBtg.do">
...
<th style="text-align: left;  ">
	...
	<c:forEach var="row" items="${map.list}" >
		...
		margin: 25px; ">
		<div style="position : relative; vertical-align : middle; line-height : 200px;" onclick="location.href='${path}/screenshot/viewBtg.do?bno=${row.bno}';">
		...
		border: 1px solid gray; overflow: hidden;" onclick="location.href='${path}/screenshot/viewBtg.do?bno=${row.bno}';">
