...
<tr ><td style="text-align: left; " colspan="3">&nbsp;&nbsp;<pre>${dto.posts}</pre></td></tr>
...
<input type="hidden" name="bno" value="${dto.bno}">
		...
		<tr><td colspan="3" style="text-align: center;">첨부파일 리스트</td></tr>
		<tr><td colspan="3">
...
$("#btnDelete").click(function(){
	if(confirm("삭제하시겠습니까?")){
		document.form1.action="${path}/screenshot/delete.do";
