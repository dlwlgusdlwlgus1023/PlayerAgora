				...
				function() {
					...
					$(".uploadedList .file").each(
							function(i) {
								...
								str += "<input type='hidden' id='game' name='game'	value='FIFA'>";
					//폼에 hidden 태그들을 붙임
					$("#form1").append(str);
...
<body>
	...
	<%@ include file="../include/headerBody.jsp"%><br><br>
	<%@ include file="../include/left_menu.jsp"%>
	<br> <br> <br> <br> <br> 
		<form id="form1" name="form1" method="post" action="${path}/screenshot/insert.do">
			<div id="writecont">
			<img src="${path}/images/scboard.jpg"
			style="width: 880px; height: 100%;"> <br> <br>
			<table id="Notice">
				<tr>
					<th>★ 피파 온라인4 스크린샷 게시판이란? ★</th>
				</tr>
				<tr>
					<td>게시판에 링크하고 싶은 이미지가 많은데 한 게시물에 업로드 가능한 개수를 초과할 경우,
						...
						<label>▶ 피파 온라인4 스크린샷 게시판 이용안내</label><br> <br> -
