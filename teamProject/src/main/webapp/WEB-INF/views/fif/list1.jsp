...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/fif/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/fif/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/fif/list1.do">피파온라인</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/fif/list1.do">
