...
<%@ page import="com.example.teamProject.model.fif.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="http://fifaonline4.nexon.com/main/index" target="_blank" id="main-banner"><img src="../images/fif_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
