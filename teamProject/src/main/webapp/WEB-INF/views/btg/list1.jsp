...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/btg/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/btg/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/btg/list1.do">배틀그라운드</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/btg/list1.do">
