...
<%@ page import="com.example.teamProject.model.btg.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://pubg.game.daum.net/pubg/index.daum" target="_blank" id="main-banner"><img src="../images/btg_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
