				...
				function() {
					...
					$(".uploadedList .file").each(
							function(i) {
								...
								str += "<input type='hidden' id='game' name='game'	value='배틀그라운드'>";
								str += "<input type='hidden' id='abb' name='abb'	value='Btg'>";
					//폼에 hidden 태그들을 붙임
					$("#form1").append(str);
...
<body>
	...
	<br> <br> <br> <br> <br> <br> 
		<form id="form1" name="form1" method="post" action="${path}/screenshot/insertBtg.do">
			<div id="writecont">
			<img src="${path}/images/btg_offer.JPG"
			style="width: 880px; height: 100%;"> <br> <br>
			<table id="Notice">
				<tr>
					<th>★ 배틀그라운드 스크린샷 게시판이란? ★</th>
				</tr>
				<tr>
					<td>게시판에 링크하고 싶은 이미지가 많은데 한 게시물에 업로드 가능한 개수를 초과할 경우,
						...
						<label>▶ 배틀그라운드 스크린샷 게시판 이용안내</label><br> <br> -
						경험치, 포인트 벌이성 게시물로 판단될 경우 경고 및 게시물 삭제의 제재가 있습니다.<br>
						- 인장용 사진, 게시물에 링크하고 싶은 이미지 외의 게시물은 자제해주세요.<br>
						- 인벤에 업로드한 이미지는 외부 사이트로의 링크가 허용되지 않으니 참고해주세요.
					</td>
				</tr>
			</table>
			<br>
			...
			<div>
				...
				<div class="fileDrop" style="overflow:auto;">
					...
					<div class="fileDrop-desc">
						...
						<div style="margin: 10px;">
						<div class="col three" style="width: 100%;">
						<a onclick="history.go(-1)" class="btn btn-dark" >목록으로</a>		
						</div>
						</div>	
						<br><br>
