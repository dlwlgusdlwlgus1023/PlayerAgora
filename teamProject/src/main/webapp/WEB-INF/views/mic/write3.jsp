...
<%@ page import="com.example.teamProject.model.mic.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://www.minecraft.net/ko-kr/" target="_blank" id="main-banner"><img src="../images/mic_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
