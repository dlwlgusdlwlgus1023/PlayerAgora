...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/mic/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/mic/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/mic/update.do";
...
<body>
	...
	<div style="height: 100%; width: 100%">
		...
		<div id="headbtn">
			<table>
				<tr>
					<td><a href="${path}/mic/list1.do">Minecraft</a></td>
					<td><a href="${path}/mic/list2.do">패치노트</a></td>
					<td><a href="${path}/mic/list3.do">공략/팁</a></td>
					<td><a href="${path}/mic/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listMic.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/mic/delete.do";
												document.form1.submit();
											}
										});
					</script>
