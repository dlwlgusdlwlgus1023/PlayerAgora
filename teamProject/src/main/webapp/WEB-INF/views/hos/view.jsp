...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/hos/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/hos/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/hos/update.do";
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/hos/delete.do";
												document.form1.submit();
											}
										});
					</script>
