...
<%@ page import="com.example.teamProject.model.sta.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="https://starcraft.com/ko-kr/" target="_blank" id="main-banner"><img src="../images/sta_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
