...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/sta/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/sta/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/sta/update.do";
...
<body>
	...
	<div style="height: 100%; width: 100%">
		...
		<div id="headbtn">
			<table>
				<tr>
					<td><a href="${path}/sta/list1.do">StarCraft</a></td>
					<td><a href="${path}/sta/list2.do">패치노트</a></td>
					<td><a href="${path}/sta/list3.do">공략/팁</a></td>
					<td><a href="${path}/sta/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listSta.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/sta/delete.do";
												document.form1.submit();
											}
										});
					</script>
