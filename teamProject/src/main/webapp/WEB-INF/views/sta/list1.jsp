...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/sta/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/sta/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/sta/list1.do">StarCraft</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/sta/list1.do">
