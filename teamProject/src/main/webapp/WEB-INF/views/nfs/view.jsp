...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/nfs/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/nfs/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/nfs/update.do";
		...
		<div id="headbtn">
			<table>
				<tr>
					...
					<td><a href="${path}/nfs/list3.do">공략/팁</a></td>
					<td><a href="${path}/nfs/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listNfs.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
						...
						<tr>
							...
							<td colspan="3">
								<div>
									<div>
										<a
											href="https://www.ea.com/ko-kr/games/need-for-speed/need-for-speed-heat"
											target="_blank" id="main-banner"><img
											src="../images/nfs_addImg.jpg"
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/nfs/delete.do";
												document.form1.submit();
											}
										});
					</script>
