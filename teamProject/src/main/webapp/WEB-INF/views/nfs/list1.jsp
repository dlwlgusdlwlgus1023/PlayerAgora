...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/nfs/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/nfs/list1.do?curPage=" + page;
	}
</script>
</head>
<body>
	<div style="height: 100%; width: 100%">
		...
		<div class="container-fluid text-center">
				...
				<table>
					<tr>
						<td style="background-color: gray;"><a
							href="${path}/nfs/list1.do">NFS</a></td>
			...
			<div class="col-md-9 text-left">
				...
				<form id="form1" method="post" action="${path}/nfs/list1.do">
