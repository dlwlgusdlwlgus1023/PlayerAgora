...
<script>
	$(function() {
		$("#btnWrite").click(function() {
			location.href = "${path}/teamProject/sud/write.do";
		});
	});
	function list(page) {
		location.href = "${path}/teamProject/sud/list.do?curPage=" + page;
	}
...
<script>
	...
	$("#btnUpdate").click(
			function() {
				...
				$("#form1").append(str);
				document.form1.action = "${path}/sud/update.do";
...
.fileDrop {
	...
	background-image: url("${path}/images/sud_addImg.jpg");
	margin-left: auto;
	margin-right: auto;
	margin-top: auto;
	margin-bottom: auto;
		...
		<div id="headbtn">
			<table>
				<tr>
					...
					<td><a href="${path}/sud/list3.do">공략/팁</a></td>
					<td><a href="${path}/sud/list4.do">파티모집</a></td>
					<td><a href="${path}/screenshot/listSud.do">스크린샷</a></td>
				</tr>
			</table>
		</div>
		<script src="../include/script.js"></script>
					...
					<table>
						...
						<tr>
							...
							<td colspan="3">
								<div>
									<div>
										<a href="http://sa.nexon.com/main/index.aspx" target="_blank"
											id="main-banner"><img src="../images/sud_addImg.jpg"
					...
					<script>
						...
						$("#btnDelete")
								.click(
										function() {
											if (confirm("삭제하시겠습니까?")) {
												document.form1.action = "${path}/sud/delete.do";
												document.form1.submit();
											}
										});
					</script>
