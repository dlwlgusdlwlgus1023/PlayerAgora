...
<%@ page import="com.example.teamProject.model.sud.dto.*"%>
...
<body>
	...
	<div id="writecont">
		...
		<form id="form1" name="form1" method="post"
			...
			<div>
				<div><a href="http://sa.nexon.com/main/index.aspx" target="_blank" id="main-banner"><img src="../images/sud_addImg.jpg" style="max-width:840px; background-size: cover;"> </a></div>
