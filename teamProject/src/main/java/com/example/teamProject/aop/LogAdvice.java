package com.example.teamProject.aop;
...
public class LogAdvice {
	...
	@Around(
	"execution(* com.example.teamProject.controller..*Controller.*(..))"
		+ " or execution(* com.example.teamProject.service..*Impl.*(..))"
		+ " or execution(* com.example.teamProject.model..dao.*Impl.*(..))")
