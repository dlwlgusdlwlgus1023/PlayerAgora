...
import com.example.teamProject.service.hos.HosReplyService;

@RestController //@ResponseBody�몴占� �겫�늿�뵠筌욑옙 占쎈륫占쎈툡占쎈즲 �뀎怨뚳옙 占쎈툡占쎈빒 占쎈쑓占쎌뵠占쎄숲 �뵳�뗪쉘 揶쏉옙占쎈뮟
//spring 4.0�겫占쏙옙苑� 占쎄텢占쎌뒠 揶쏉옙占쎈뮟
@RequestMapping("reply_hos/*")
public class HosReplyController {
	@Inject
	HosReplyService replyService;
	
	@RequestMapping("insert.do")
	public void insert(HosReplyDTO dto, HttpSession session) {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<HosReplyDTO> list=replyService.list(bno);
		mav.setViewName("hos/reply_hos"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<HosReplyDTO> list_json(int bno){
