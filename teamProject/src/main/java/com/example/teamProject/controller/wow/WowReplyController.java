...
import com.example.teamProject.service.wow.WowReplyService;

@RestController //@ResponseBody�몴占� �겫�늿�뵠筌욑옙 占쎈륫占쎈툡占쎈즲 �뀎怨뚳옙 占쎈툡占쎈빒 占쎈쑓占쎌뵠占쎄숲 �뵳�뗪쉘 揶쏉옙占쎈뮟
//spring 4.0�겫占쏙옙苑� 占쎄텢占쎌뒠 揶쏉옙占쎈뮟
@RequestMapping("reply_wow/*")
public class WowReplyController {
	@Inject
	WowReplyService replyService;
	
	@RequestMapping("insert.do")
	public void insert(WowReplyDTO dto, HttpSession session) {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<WowReplyDTO> list=replyService.list(bno);
		mav.setViewName("wow/reply_wow"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<WowReplyDTO> list_json(int bno){
