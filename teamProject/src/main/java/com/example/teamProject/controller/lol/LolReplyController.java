...
public class LolReplyController {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<LolReplyDTO> list=replyService.list(bno);
		mav.setViewName("lol/reply_lol"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<LolReplyDTO> list_json(int bno){
