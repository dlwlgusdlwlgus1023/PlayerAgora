...
import com.example.teamProject.service.mps.MpsReplyService;

@RestController //@ResponseBody�몴占� �겫�늿�뵠筌욑옙 占쎈륫占쎈툡占쎈즲 �뀎怨뚳옙 占쎈툡占쎈빒 占쎈쑓占쎌뵠占쎄숲 �뵳�뗪쉘 揶쏉옙占쎈뮟
//spring 4.0�겫占쏙옙苑� 占쎄텢占쎌뒠 揶쏉옙占쎈뮟
@RequestMapping("reply_mps/*")
public class MpsReplyController {
	@Inject
	MpsReplyService replyService;
	
	@RequestMapping("insert.do")
	public void insert(MpsReplyDTO dto, HttpSession session) {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<MpsReplyDTO> list=replyService.list(bno);
		mav.setViewName("mps/reply_mps"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<MpsReplyDTO> list_json(int bno){
