...
public class LoaReplyController {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<LoaReplyDTO> list=replyService.list(bno);
		mav.setViewName("loa/reply_loa"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<LoaReplyDTO> list_json(int bno){
