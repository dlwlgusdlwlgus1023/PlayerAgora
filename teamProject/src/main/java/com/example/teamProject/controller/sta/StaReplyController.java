...
import com.example.teamProject.service.sta.StaReplyService;

@RestController //@ResponseBody�몴占� �겫�늿�뵠筌욑옙 占쎈륫占쎈툡占쎈즲 �뀎怨뚳옙 占쎈툡占쎈빒 占쎈쑓占쎌뵠占쎄숲 �뵳�뗪쉘 揶쏉옙占쎈뮟
//spring 4.0�겫占쏙옙苑� 占쎄텢占쎌뒠 揶쏉옙占쎈뮟
@RequestMapping("reply_sta/*")
public class StaReplyController {
	@Inject
	StaReplyService replyService;
	
	@RequestMapping("insert.do")
	public void insert(StaReplyDTO dto, HttpSession session) {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<StaReplyDTO> list=replyService.list(bno);
		mav.setViewName("sta/reply_sta"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<StaReplyDTO> list_json(int bno){
