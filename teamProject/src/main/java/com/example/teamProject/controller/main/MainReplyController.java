...
import com.example.teamProject.service.main.MainReplyService;

@RestController //@ResponseBody�몴占� �겫�늿�뵠筌욑옙 占쎈륫占쎈툡占쎈즲 �뀎怨뚳옙 占쎈툡占쎈빒 占쎈쑓占쎌뵠占쎄숲 �뵳�뗪쉘 揶쏉옙占쎈뮟
//spring 4.0�겫占쏙옙苑� 占쎄텢占쎌뒠 揶쏉옙占쎈뮟
@RequestMapping("reply_main/*")
public class MainReplyController {
	@Inject
	MainReplyService replyService;
	
	@RequestMapping("insert.do")
	public void insert(MainReplyDTO dto, HttpSession session) {
	...
	public ModelAndView list(int bno, ModelAndView mav) {
		List<MainReplyDTO> list=replyService.list(bno);
		mav.setViewName("main/reply_main"); //�뀎怨쀬벥 占쎌뵠�뵳占�
	...
	public List<MainReplyDTO> list_json(int bno){
