package com.example.teamProject.model.hos.dto;

import java.util.Date;

public class HosReplyDTO {
	private int rno; 
	private int bno; 
	...
	public String toString() {
		return "HosReplyDTO [rno=" + rno + ", bno=" + bno + ", replytext=" + replytext + ", replyer=" + replyer
				+ ", name=" + name + ", regdate=" + regdate + ", updatedate=" + updatedate + ", secret_reply="
				+ secret_reply + ", writer=" + writer + ", nick=" + nick + "]";
	}
